...
async function connectToDatabase(retries = 5, delay = 5000) { // Set default retries and delay
  ...
  process.exit(1); // Exit the process if the database connection fails after all retries
}


// Function to create the alert_thresholds table if it does not exist
